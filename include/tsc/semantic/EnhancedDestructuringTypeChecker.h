...
// =============================================================================
// ENHANCED DESTRUCTURING TYPE CHECKER
// =============================================================================

class EnhancedDestructuringTypeChecker {
private:
    ...
    bool canDestructureFromType(DestructuringPattern* pattern, Type* type);
    ...
    UnionType* createUnionType(const std::vector<Type*>& memberTypes);
    
public:
    EnhancedDestructuringTypeChecker(SemanticAnalyzer* analyzer);
