...
## Project Vision
TSC is a TypeScript-syntax static language compiler that generates native binaries using LLVM. It provides TypeScript-like syntax with static typing, compiling directly to optimized native code without JavaScript runtime overhead.
