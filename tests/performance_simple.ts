...
interface Constraint4<T extends string[]> { value: T; }
interface Constraint5<T extends number[]> { value: T; }
interface Constraint6<T extends boolean[]> { value: T; }
interface Constraint7<T extends "success"> { value: T; }
interface Constraint8<T extends "error"> { value: T; }
interface Constraint9<T extends true> { value: T; }
interface Constraint10<T extends false> { value: T; }
...
function process4<T extends string[]>(value: T): T { return value; }
function process5<T extends number[]>(value: T): T { return value; }
function process6<T extends boolean[]>(value: T): T { return value; }
function process7<T extends "success">(value: T): T { return value; }
function process8<T extends "error">(value: T): T { return value; }
function process9<T extends true>(value: T): T { return value; }
function process10<T extends false>(value: T): T { return value; }

// Test 6: Complex multi-constraint functions
function multi1<T extends string, U extends number>(text: T, count: U): T { return text; }
function multi2<T extends number, U extends boolean>(value: T, flag: U): T { return value; }
function multi3<T extends string, U extends boolean>(text: T, flag: U): T { return text; }