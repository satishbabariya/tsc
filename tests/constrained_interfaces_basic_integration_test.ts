// Basic integration tests for constrained interfaces
// Testing core constraint functionality with supported syntax
...
// Test 9: Interface with parameter constraints (simplified)
...
// Test 17: Interface with readonly property constraints
interface ReadonlyPropertyConstraint<T extends number> {
    readonly value: T;
    readonly array: T[];
    mutable: T;
}

// Test 18: Interface with index signature constraints
interface IndexSignatureConstraint<T extends number> {
    [key: string]: T;
    count: T;
}
...
// Test 20: Interface with overloaded method constraints
interface OverloadedMethodConstraint<T extends number> {
    process(value: T): T;
    process(value: T, multiplier: T): T;
    process(value: T, multiplier: T, offset: T): T;
}