// Simple test for generic function constraints
// This tests the core generic function constraint functionality without complex object types
...
// Test 9: Generic function with multi-dimensional array constraint
function processMatrix<T extends number[][]>(matrix: T): T {
    return matrix;
}

// Test 10: Generic function with string array constraint
function processStringArray<T extends string[]>(strings: T): T {
    return strings;
}