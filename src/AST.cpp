...
namespace tsc {
    ...
    String BinaryExpression::toString() const {
        ...
        switch (operator_) {
            case Operator::Add: ss << " + ";
                break;
            case Operator::Subtract: ss << " - ";
                break;
            case Operator::Multiply: ss << " * ";
                break;
            case Operator::Divide: ss << " / ";
                break;
            case Operator::Modulo: ss << " % ";
                break;
            case Operator::Power: ss << " ** ";
                break;
            case Operator::Equal: ss << " == ";
                break;
            case Operator::NotEqual: ss << " != ";
                break;
            case Operator::StrictEqual: ss << " === ";
                break;
            case Operator::StrictNotEqual: ss << " !== ";
                break;
            case Operator::Less: ss << " < ";
                break;
            case Operator::Greater: ss << " > ";
                break;
            case Operator::LessEqual: ss << " <= ";
                break;
            case Operator::GreaterEqual: ss << " >= ";
                break;
            case Operator::LogicalAnd: ss << " && ";
                break;
            case Operator::LogicalOr: ss << " || ";
                break;
            case Operator::NullishCoalescing: ss << " ?? ";
                break;
            case Operator::BitwiseAnd: ss << " & ";
                break;
            case Operator::BitwiseOr: ss << " | ";
                break;
            case Operator::BitwiseXor: ss << " ^ ";
                break;
            case Operator::LeftShift: ss << " << ";
                break;
            case Operator::RightShift: ss << " >> ";
                break;
            case Operator::UnsignedRightShift: ss << " >>> ";
                break;
            case Operator::In: ss << " in ";
                break;
            case Operator::Instanceof: ss << " instanceof ";
                break;
            case Operator::As: ss << " as ";
                break;
            case Operator::Satisfies: ss << " satisfies ";
                break;
        }
    ...
    String UnaryExpression::toString() const {
        ...
        if (prefix_) {
            switch (operator_) {
                case Operator::Plus: ss << "+";
                    break;
                case Operator::Minus: ss << "-";
                    break;
                case Operator::BitwiseNot: ss << "~";
                    break;
                case Operator::LogicalNot: ss << "!";
                    break;
                case Operator::PreIncrement: ss << "++";
                    break;
                case Operator::PreDecrement: ss << "--";
                    break;
                case Operator::Typeof: ss << "typeof ";
                    break;
                case Operator::Delete: ss << "delete ";
                    break;
                case Operator::Void: ss << "void ";
                    break;
                case Operator::Await: ss << "await ";
                    break;
                default: break;
            }
    ...
    String AssignmentExpression::toString() const {
        ...
        switch (operator_) {
            case Operator::Assign: ss << " = ";
                break;
            case Operator::AddAssign: ss << " += ";
                break;
            case Operator::SubtractAssign: ss << " -= ";
                break;
            case Operator::MultiplyAssign: ss << " *= ";
                break;
            case Operator::DivideAssign: ss << " /= ";
                break;
            case Operator::ModuloAssign: ss << " %= ";
                break;
            case Operator::LeftShiftAssign: ss << " <<= ";
                break;
            case Operator::RightShiftAssign: ss << " >>= ";
                break;
            case Operator::UnsignedRightShiftAssign: ss << " >>>= ";
                break;
            case Operator::BitwiseAndAssign: ss << " &= ";
                break;
            case Operator::BitwiseOrAssign: ss << " |= ";
                break;
            case Operator::BitwiseXorAssign: ss << " ^= ";
                break;
            case Operator::PowerAssign: ss << " **= ";
                break;
            case Operator::NullishCoalescingAssign: ss << " ??= ";
                break;
            case Operator::LogicalAndAssign: ss << " &&= ";
                break;
            case Operator::LogicalOrAssign: ss << " ||= ";
                break;
        }
    ...
    String VariableDeclaration::toString() const {
        ...
        switch (kind_) {
            case Kind::Var: ss << "var ";
                break;
            case Kind::Let: ss << "let ";
                break;
            case Kind::Const: ss << "const ";
                break;
        }
