...
namespace tsc {
    ...
    void EnhancedErrorReporting::reportUnexpectedToken(const SourceLocation &location, const String &expected,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Syntax::UNEXPECTED_TOKEN_SUGGESTION, expected)
                         : suggestion;
    ...
    void EnhancedErrorReporting::reportExpectedToken(const SourceLocation &location, const String &expected,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Syntax::EXPECTED_TOKEN_SUGGESTION, expected)
                         : suggestion;
    ...
    void EnhancedErrorReporting::reportMissingBrace(const SourceLocation &location, const String &braceType,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Syntax::MISSING_BRACE_SUGGESTION, braceType)
                         : suggestion;
    ...
    void EnhancedErrorReporting::reportMissingParenthesis(const SourceLocation &location, const String &parenType,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Syntax::MISSING_PARENTHESIS_SUGGESTION, parenType)
                         : suggestion;
    ...
    void EnhancedErrorReporting::reportMissingBracket(const SourceLocation &location, const String &bracketType,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Syntax::MISSING_BRACKET_SUGGESTION, bracketType)
                         : suggestion;
    ...
    void EnhancedErrorReporting::reportInvalidFunctionSignature(const SourceLocation &location,
                                                                const String &suggestion) {
    ...
    void EnhancedErrorReporting::reportInvalidClassDeclaration(const SourceLocation &location,
                                                               const String &suggestion) {
    ...
    void EnhancedErrorReporting::reportInvalidInterfaceDeclaration(const SourceLocation &location,
                                                                   const String &suggestion) {
        String message = ErrorMessages::Syntax::INVALID_INTERFACE_DECLARATION_MSG;
        String sug = suggestion.empty()
                         ? ErrorSuggestions::Syntax::INVALID_INTERFACE_DECLARATION_SUGGESTION
                         : suggestion;
        addDiagnostic(DiagnosticLevel::Error, ErrorCodes::Syntax::INVALID_INTERFACE_DECLARATION, location, message,
                      sug);
    }

    void EnhancedErrorReporting::reportInvalidEnumDeclaration(const SourceLocation &location,
                                                              const String &suggestion) {
    ...
    void EnhancedErrorReporting::reportTypeMismatch(const SourceLocation &location, const String &expected,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Type::TYPE_MISMATCH_SUGGESTION, expected, actual)
                         : suggestion;
    ...
    void EnhancedErrorReporting::reportUndefinedVariable(const SourceLocation &location, const String &name,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Type::UNDEFINED_VARIABLE_SUGGESTION, name)
                         : suggestion;
    ...
    void EnhancedErrorReporting::reportUndefinedFunction(const SourceLocation &location, const String &name,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Type::UNDEFINED_FUNCTION_SUGGESTION, name)
                         : suggestion;
    ...
    void EnhancedErrorReporting::reportUndefinedProperty(const SourceLocation &location, const String &property,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Type::UNDEFINED_PROPERTY_SUGGESTION, property, type)
                         : suggestion;
    ...
    void EnhancedErrorReporting::reportUndefinedType(const SourceLocation &location, const String &type,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Type::UNDEFINED_TYPE_SUGGESTION, type)
                         : suggestion;
    ...
    void EnhancedErrorReporting::reportMissingTypeAnnotation(const SourceLocation &location, const String &name,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Type::MISSING_TYPE_ANNOTATION_SUGGESTION, name, "any")
                         : suggestion;
    ...
    void EnhancedErrorReporting::reportGenericTypeError(const SourceLocation &location, const String &generic,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Type::GENERIC_TYPE_ERROR_SUGGESTION, generic)
                         : suggestion;
    ...
    void EnhancedErrorReporting::reportUnionTypeError(const SourceLocation &location, const String &unionType,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Type::UNION_TYPE_ERROR_SUGGESTION, unionType)
                         : suggestion;
    ...
    void EnhancedErrorReporting::reportIntersectionTypeError(const SourceLocation &location, const String &intersection,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Type::INTERSECTION_TYPE_ERROR_SUGGESTION, intersection)
                         : suggestion;
    ...
    void EnhancedErrorReporting::reportArrayTypeError(const SourceLocation &location, const String &array,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Type::ARRAY_TYPE_ERROR_SUGGESTION, array)
                         : suggestion;
    ...
    void EnhancedErrorReporting::reportObjectTypeError(const SourceLocation &location, const String &object,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Type::OBJECT_TYPE_ERROR_SUGGESTION, object)
                         : suggestion;
    ...
    void EnhancedErrorReporting::reportFunctionTypeError(const SourceLocation &location, const String &function,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Type::FUNCTION_TYPE_ERROR_SUGGESTION, function)
                         : suggestion;
    ...
    void EnhancedErrorReporting::reportClassTypeError(const SourceLocation &location, const String &class_,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Type::CLASS_TYPE_ERROR_SUGGESTION, class_)
                         : suggestion;
    ...
    void EnhancedErrorReporting::reportInterfaceTypeError(const SourceLocation &location, const String &interface,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Type::INTERFACE_TYPE_ERROR_SUGGESTION, interface)
                         : suggestion;
    ...
    void EnhancedErrorReporting::reportEnumTypeError(const SourceLocation &location, const String &enum_,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Type::ENUM_TYPE_ERROR_SUGGESTION, enum_)
                         : suggestion;
    ...
    void EnhancedErrorReporting::reportTupleTypeError(const SourceLocation &location, const String &tuple,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Type::TUPLE_TYPE_ERROR_SUGGESTION, tuple)
                         : suggestion;
    ...
    void EnhancedErrorReporting::reportLiteralTypeError(const SourceLocation &location, const String &literal,
        ...
        String sug = suggestion.empty()
                         ? formatSuggestion(ErrorSuggestions::Type::LITERAL_TYPE_ERROR_SUGGESTION, literal)
                         : suggestion;
    ...
    void EnhancedErrorReporting::addDiagnostic(DiagnosticLevel level, const String &code,
