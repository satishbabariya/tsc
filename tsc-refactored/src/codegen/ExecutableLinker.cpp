...
namespace tsc {
    ...
    bool ExecutableLinker::linkExecutable(const std::vector<String> &objectFiles, const String &outputFile,
    ...
    bool ExecutableLinker::linkWithLLD(const std::vector<String> &objectFiles, const String &outputFile,
                                       const String &targetTriple) {
        try {
    ...
    bool ExecutableLinker::linkWithSystemLinker(const std::vector<String> &objectFiles, const String &outputFile,
                                                const String &targetTriple) {
        try {
